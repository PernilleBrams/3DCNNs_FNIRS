...
# -- Put path to folder to your epoch_cubes .npy files
folder_cubes = "/path"

# -- Put path to folder to your epoch_cube_labels files
...
# -- Make test set   
test_paths = [
    f"{folder_cubes}/3D_epoch_cubes_NP-Ph2-306_8DEC_Condition1_3D_version.npy",
    f"{folder_cubes}/3D_epoch_cubes_NP-Ph2-104_8DEC_Condition1_visual_3D_version.npy",
    f"{folder_cubes}/3D_epoch_cubes_NP-Ph2-123_8DEC_Condition1_visual_3D_version.npy",
    f"{folder_cubes}/3D_epoch_cubes_NP-Ph2-125_8DEC_Condition1_visual_3D_version.npy"]
...
def change_labels_verbatim(label_array):
    ...
    for label in label_array: 
        if label in (73,74,75,76,77,78,70,71,72): 
            verb_label_array.append("Condition1")
        elif label in (55,56,57,58,59,60,52,53,54):
